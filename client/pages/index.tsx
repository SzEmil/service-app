...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    if (isServerConnected) dispatch(refreshUser());
  }, [dispatch]);
  ...
  return (
    <>
      {isServerConnected ? (
          ...
          <main className={styles.main}>
            <div className={styles.descriptionBox}>
              ...
              <p className={styles.about}>
                ...
                service with our intuitive restaurant management app. Create
                your own restaurant, add tables, and easily track orders within
                each table. Say goodbye to confusion and enjoy the smoothest
                dining experience for both staff and customers. Join us today
                and revolutionize your restaurant operations!
              </p>
            </div>
        ...
        <div
          className={`${styles.loadingPage} ${
            !isServerConnected ? styles.loadingActive : null
          }`}
        >
          <LoadingPage />
        </div>
